...
%   r: Number of columns of Z (number of communities)
%
% Options (varargin)
...
function [w_best,v_best,S_best,error_best,time_global,time_iteration] = frost(X,r,varargin)
...
for trials = 1:options.numTrials
    ...
    for itt = 1:options.maxiter
        ...
        % Construction of S O(nnz(X)) S = Z^TXZ when Z^TZ=I
